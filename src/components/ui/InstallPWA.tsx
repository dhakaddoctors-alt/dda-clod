...
export default function InstallPWA({ variant = 'button' }: { variant?: 'button' | 'minimal' }) {
    ...
    return (
      <>
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-blue-600 text-white text-[10px] font-bold uppercase tracking-wider shadow-sm hover:bg-blue-700 transition-all active:scale-95"
        >
          <Download className="w-3.5 h-3.5 shrink-0" />
          <span>Install App</span>
        </button>
        {/* iOS Manual Install Modal - Shared across variants */}
        {showiOSModal && (
...
// Extract modal to avoid duplication in variants
